  ...
  const milestones = [
    {
      ...
      description:
        "Né dans un quartier pauvre, école de mauvaise qualité, opportunités rares.",
    },
    {
      year: "Adolescence",
      location: "Djibouti",
      ...
      description:
        "Pendant que d'autres abandonnaient ou sombraient dans le khat, j'ai choisi la lecture.",
    },
    {
      year: "Université",
      location: "Djibouti",
      title: "Mathématiques",
      description:
        "Études en mathématiques à l'Université de Djibouti, première étape vers l'excellence.",
    },
    {
      year: "Master",
      ...
      description:
        "Master en mathématiques fondamentales à l'Université de Besançon.",
    },
    {
      year: "Enseignement",
      location: "Djibouti",
      ...
      description:
        "Enseignant à l'Université et dans les classes préparatoires du lycée d'excellence.",
    },
    {
      year: "Aujourd'hui",
      location: "États-Unis",
      ...
      description:
        "Je vis aux États-Unis et partage ce qui m'a sauvé : la lecture, la discipline, l'apprentissage.",
    },
  ];
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-20 animate-fade-in">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              Un parcours fait de détermination, de lecture et de discipline.
              Voici comment j&apos;ai transformé ma vie, un livre à la fois.
            </p>
          </div>
          ...
          <div className="mt-20 text-center animate-fade-in">
            <div className="bg-gradient-to-r from-primary/5 to-primary/10 rounded-2xl p-8 border">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
                Ce blog, je l&apos;ai créé pour partager ce qui m&apos;a sauvé :
                la lecture, la discipline, et l&apos;envie d&apos;apprendre.
                <br />
                <br />
